...
%define kernel_ver	4.18.0-305.25.1.el8_4
...
%changelog
* Wed Oct 20 2021 Joe Lawrence <joe.lawrence@redhat.com> [0-0.el8_4]
- An empty patch to subscribe to kpatch stream for kernel-4.18.0-305.25.1.el8_4 [2016071]
